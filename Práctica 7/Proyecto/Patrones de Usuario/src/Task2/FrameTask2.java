 ...
 * @author Zabai Armas
 */
public class FrameTask2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(Album, javax.swing.GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Album, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
        );
    ...
    private void ItemOpenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ItemOpenActionPerformed
        ...
        if(returned == JFileChooser.APPROVE_OPTION){
            ...
            Album.add(file.getName(), viewer);
            // Mejora, cambia de panel cuando abres una imagen nueva
    ...
    private void ItemCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ItemCloseActionPerformed
        ...
        if(index != -1) Album.removeTabAt(index);
